...
printf '%s\n' '<rehydrate-trigger>'
printf '%s\n' '<rehydrate-runtime version="0.4.3" />'
...
case $skill_content in
*[![:space:]]*)
  printf '%s\n' 'The complete skill body is embedded below and is already loaded. Do not open or resolve a cached SKILL.md locator from an earlier task snapshot; it may refer to a removed plugin version after an update.'
  printf '%s\n' '<skill>'
